...
public class AddReservationDialog extends JDialog {
    ...
    public AddReservationDialog(JFrame parent, boolean modal, Runnable onReservationAdded) {
        super(parent, "Add New Reservation", modal);
        setSize(500, 500);
        ...
        classComboBox = new JComboBox<>(new String[]{"Economy", "First Class", "Business"});

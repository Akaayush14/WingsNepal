...
public class RegisterPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try {
            java.net.URL imageURL = getClass().getResource("/imagepicker/Aeroplane image 1.jpg");
            if (imageURL != null) {
                BgImageLabel.setIcon(new javax.swing.ImageIcon(imageURL));
            } else {
                // Fallback if image not found
                BgImageLabel.setBackground(new java.awt.Color(70, 130, 180));
                BgImageLabel.setOpaque(true);
                System.out.println("Background image not found, using color fallback");
            }
        } catch (Exception e) {
            // Error handling
            BgImageLabel.setBackground(new java.awt.Color(70, 130, 180));
    ...
    private void SignUpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpButtonActionPerformed
        // handleRegistration(); // REMOVED - now handled by controller
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new controller.RegisterPageController(view).open();
            }
        });
    }
    ...
    // Added getters for phone and gender
    public javax.swing.JTextField getPhoneTextField() {
        return PhoneTextField;
    }

    public javax.swing.JComboBox<String> getGenderComboBox() {
